...
$(document).ready(function () {
  ...
  new Switchery(document.getElementById("demo-sw-light-blue"), {
    color: "#35b9e7",
  });
  new Switchery(document.getElementById("demo-sw-green"), { color: "#44ba56" });
  new Switchery(document.getElementById("demo-sw-orange"), {
    color: "#f0a238",
  });
  ...
  new Switchery(document.getElementById("demo-sw-purple"), {
    color: "#8669cc",
  });
  ...
  // http://abpetkov.github.io/switchery/
  // =================================================================
  new Switchery(document.getElementById("demo-sw-disabled"), {
    disabled: true,
  });
  ...
  // http://abpetkov.github.io/switchery/
  // =================================================================
  new Switchery(document.getElementById("demo-sw-opacity-disabled"), {
    disabled: true,
  ...
  // http://abpetkov.github.io/switchery/
  // =================================================================
  new Switchery(document.getElementById("demo-sw-customize-switchery"), {
    color: "#7c8bc7",
    jackColor: "#9decff",
  });
  new Switchery(document.getElementById("demo-sw-customize-switchery-type2"), {
    color: "#faab43",
    secondaryColor: "#fC73d0",
    jackColor: "#fcf45e",
    jackSecondaryColor: "#c8ff77",
  });
  new Switchery(document.getElementById("demo-sw-customize-switchery-type3"), {
    color: "#35b9e7",
    secondaryColor: "#e33a4b",
    jackColor: "#ffffff",
    jackSecondaryColor: "#c8ff77",
  });
});
